        ...
        <div class="row">
            <div class="col-lg-10 mb-5 addTextMotherDiv">
                <div style="text-align: right;padding: 10px;">
                    <h5 id="addTextTitle">İçerik Ekleme Alanı</h5>
                </div>
                ...
                <form action="usage_database/add_new_content.php" id="addNewContent" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="titleContent" class="form-control" maxlength="99" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="textareaContent" id="textareaEditor"></textarea>
                            <script>
                                // Nedense textareaContent deyinec double click sorunu çıkıyor yani resmi
                                //seçmesi gerekirken açıp büyütüyor...
                                // id textareaContente yaptım sonune bir "e" koydum şimdilik
